...
class MyBookVC: UIViewController {
    ...
    var myBookWebService = MyBookWebService()
    ...
    private func fetchInitialData() {
        myBookWebService.fetchUserBookList()
    ...
    func deleteBookAtBookMarkedList(_ deleteBookInfo: MarkedBookModel) {
        ...
        if let index = mainVC.markedBookListVM.books.firstIndex(of: deleteBookInfo) {
            
            mainVC.markedBookListVM.removeMarkedBook(index)
